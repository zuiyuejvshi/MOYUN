...
app = Flask(__name__,
            ...
            static_url_path='/static')  # 修改静态文件配置
...
def index():
    ...
    else:  # 用户发起访问请求Https://mirrors.tuna.tsinghua.edu.cn
...
def bookMenu():
    ...
    for book in books:
        ...
        # render_template("groupMenu.html", loginUser=session.get("loginUser"), groups=groups)
